...
use Drupal\Core\Url;
use Drupal\node\Entity\Node;
use Drupal\pocam_extract\Controller\PocamExtractController;
...
class Import extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // TODO: This might not be necessary after validation. If it is,
  ...
  public static function pocam_extract_import_extract_finished($success, $results, $operations) {
    ...
    foreach ($results as $result) {
      $items[] = t('Imported extract %title.', array(
        '%title' => $result,
      ));
    }
